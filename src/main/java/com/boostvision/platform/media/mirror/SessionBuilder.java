...
import com.boostvision.platform.media.mirror.stream.audio.AACStream;
import com.boostvision.platform.media.mirror.stream.audio.AMRNBStream;
import com.boostvision.platform.media.mirror.stream.audio.AudioQuality;
import com.boostvision.platform.media.mirror.stream.audio.AudioStream;
import com.boostvision.platform.media.mirror.stream.video.H264Stream;
import com.boostvision.platform.media.mirror.stream.video.VideoQuality;
import com.boostvision.platform.media.mirror.stream.video.VideoStream;
